      ...
      <Container>
        <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              {highlights.map((highlight, index) => (
                <motion.div
                  ...
                  className="glass-premium rounded-xl p-4 text-center"
                >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Card className="aspect-square flex items-center justify-center bg-gradient-to-br from-purple-500/10 to-blue-500/10 border-2 border-purple-500/20">
              <div className="text-center">
                <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center glow-soft">
                  <span className="text-4xl font-bold text-white">AK</span>
                </div>
                <p className="text-white/50 text-sm">Portrait Photo Placeholder</p>
                <p className="text-white/30 text-xs mt-2">Replace with optimized image</p>
              </div>
            </Card>
          </motion.div>
        </div>
